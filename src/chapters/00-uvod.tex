...
reality. Tyto podniky se označují jako \emph{herny virtuální reality}. **cit**
...
prostředí. Technologie tak vytváří iluzi reálného alternativního světa. **cit**
...
controlled by movement of the body'' **cit** lze přeložit jako ``realistická a
...
objekty. **cit** Virtuální realita nalézá uplatnění v průmyslu, lékařství,
sportu, armádě a především i v zábavním průmyslu. **cit**
...
vypouštět aromatické látky pro pohlcující zážitek. **cit**
...
také počítačový výkon. **cit** Právě kvůli virtuální realitě začal v poslední
...
nejoblíbenějších systémů virtuální reality v současnosti. **cit** Současně s
...
haptickou odezvou. **cit** Díky laserovému snímání je možné velmi přesně snímat
...
přibližně 24 tisíc korun. **cit** Koncovým zákazníkům se stal dostupným v dubnu
...
přidána experimentální podpora systémů \emph{Oculus Rift} a \emph{OSVR}. **cit**
